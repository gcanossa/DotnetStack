...
namespace GKit.RENTRI.Stubs.VidimazioneFormulari
{
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        /// <br/>
        /// <br/>Se si indica anche il numero iscrizione unità locale, vengono restituiti solo i blocchi dell'unità locale specificata.
        /// <br/>
        /// <br/>La creazione dei blocchi è possibile solo nell'area web Operatori, tramite la funzionalità Interoperabilità/Gestione blocchi virtuali dei FIR.
        /// <br/>
        /// <br/>Nell'ambiente DEMO è possibile creare al massimo 100 blocchi per operatore.
        /// <br/>
        /// <br/>Nell'ambiente PRODUZIONE è possibile creare al massimo 500 blocchi per operatore.
        /// </remarks>
        /// <param name="identificativo">Codice fiscale del soggetto per il quale recuperare i blocchi</param>
        /// <param name="num_iscr_sito">Numero iscrizione unità locale per il quale recuperare i blocchi</param>
        ...
        /// <summary>
        /// 🔁[ASYNC] Vidimazione nuovo FIR
        /// </summary>
        /// <remarks>
        /// Acquisisce la richiesta di vidimazione di un nuovo FIR per il blocco specificato.
        /// <br/>
        /// <br/>Il servizio di vidimazione è soggetto a limiti giornalieri in funzione del tipo di blocco per cui si richiede la vidimazione.
        /// <br/>
        /// <br/>Nell'ambiente DEMO le richieste giornaliere effettuabili per operatore sono 500 sull'insieme dei blocchi non associati a unità locali e 500 sull'insieme dei blocchi associati ad una stessa unità locale.
        /// <br/>
        /// <br/>Nell'ambiente PRODUZIONE le richieste giornaliere effettuabili per operatore sono 1000 sull'insieme dei blocchi non associati a unità locali e 1000 sull'insieme dei blocchi associati ad una stessa unità locale.
        ...
        /// <param name="xml">Se valorizzato a true nella struttura dati restituita viene valorizzato anche la proprietà xml contenente il file XML firmato che rappresenta la validazione.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        ...
        /// <br/>
        /// <br/>Le condizioni affinché l'annullamento del numero FIR venga eseguito sono:
        ...
        /// <param name="codice_blocco">Codice del blocco a cui appartiene il FIR per cui si richiedono i dati.</param>
        /// <param name="progressivo">Numero progressivo del FIR per cui si richiedono i dati.</param>
        /// <param name="senza_numero_pagina">Se valorizzato a true il numero di pagina non è presente.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
    ...
    public partial class EfirModel
    {
        ...
        /// <summary>
        /// Array di byte contenuto nel codice QR Code che consente di verificare la validità del FIR.
