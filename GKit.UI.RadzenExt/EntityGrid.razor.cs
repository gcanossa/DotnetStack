...
/// </summary>
/// <remarks>
/// Apart from the rendered markup, this is the same component as the MudBlazor adapter's: the
/// DbContext lifecycle, paging and CRUD orchestration are the shared
/// <see cref="EntityGridEngine{T}"/> and <see cref="EntityCrudOrchestrator{T}"/>.
/// </remarks>
